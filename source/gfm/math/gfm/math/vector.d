    ...
    public
    {
        ...
        static if (isFloatingPoint!T)
        {
            ...
            static if (N == 3)
            {
				...
				@nogc static Vector!(T, N) forward() {
					return Vector!(T, N)(0, 0, 1);
				}

				@nogc static Vector!(T, N) back() {
					return Vector!(T, N)(0, 0, -1);
				}

				@nogc static Vector!(T, N) up() {
					return Vector!(T, N)(0, 1, 0);
				}

				@nogc static Vector!(T, N) down() {
					return Vector!(T, N)(0, -1, 0);
				}

				@nogc static Vector!(T, N) right() {
					return Vector!(T, N)(1, 0, 0);
				}

				@nogc static Vector!(T, N) left() {
					return Vector!(T, N)(-1, 0, 0);
				}

				@nogc static Vector!(T, N) one() {
					return Vector!(T, N)(1, 1, 1);
				}

				@nogc static Vector!(T, N) zero() {
					return Vector!(T, N)(0, 0, 0);
				}
            }
        }
    }
